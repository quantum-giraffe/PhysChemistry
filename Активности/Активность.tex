...
\begin{enumerate}
\item Оценим вклад электропроводности \ce{CaSO4} в присутствии солей хлорида калия и сульфата натрия:
...
\item Найдем концентрации ионов \ce{Ca^{2+}} \ce{SO4^{2-}} в присутствии и в отсутствие других солей:
